...
namespace LaboApiGroup_API.Controllers
{
    ...
    public class RoleOfUserController : ControllerBase
    {
        ...
        {
            return Ok(_RoleOfUser_service.Insert(RoleOfUser.ToBLL()));
        }

        [HttpPut]
        public IActionResult Update(RoleOfUser_C RoleOfUser)
        {
            return Ok(_RoleOfUser_service.Update(RoleOfUser.ToBLL()));
        }
        ...
        public IActionResult Delete(int id)
        {
            ...
            rou.Id = id;
            return Ok(_RoleOfUser_service.Delete(rou.ToBLL()));
        }
