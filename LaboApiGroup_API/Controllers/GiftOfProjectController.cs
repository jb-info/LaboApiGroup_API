...
namespace LaboApiGroup_API.Controllers
{
    ...
    public class GiftOfProjectController : ControllerBase
    {
        ...
        {
            return Ok(_giftofproject_service.Insert(GiftOfProject.ToBLL()));
        }

        [HttpPut]
        public IActionResult Update(GiftOfProject_C GiftOfProject)
        {
            return Ok(_giftofproject_service.Update(GiftOfProject.ToBLL()));
        }
        ...
        public IActionResult Delete(int id)
        {
            ...
            gop.Id = id;
            return Ok(_giftofproject_service.Delete(gop.ToBLL()));
